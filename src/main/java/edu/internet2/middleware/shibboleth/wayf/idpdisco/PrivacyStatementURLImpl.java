...
/**
 * Concrete implementation of {@link edu.internet2.middleware.shibboleth.wayf.idpdisco.PrivacyStatementURL}.
...
public class PrivacyStatementURLImpl extends LocalizedURIImpl implements PrivacyStatementURL {
    ...
    /** {@inheritDoc} */
    public void setURL(LocalizedString newPrivacyURL) {
        setURI(newPrivacyURL);
    }
