...
/**
 * A thread safe Marshaller for {@link edu.internet2.middleware.shibboleth.wayf.idpdisco.Logo} objects.
 */
public class LogoMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallElementContent(XMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        if (logo.getURL() != null) {
            XMLHelper.appendTextContent(domElement, logo.getURL().getLocalString());
        }
    }
}