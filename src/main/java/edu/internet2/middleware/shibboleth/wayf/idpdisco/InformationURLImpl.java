...
/**
 * Concrete implementation of {@link edu.internet2.middleware.shibboleth.wayf.idpdisco.InformationURL}.
...
public class InformationURLImpl extends LocalizedURIImpl implements InformationURL {
    ...
    /** {@inheritDoc} */
    public void setURL(LocalizedString newInformationURL) {
        setURL(newInformationURL);
    }
}
